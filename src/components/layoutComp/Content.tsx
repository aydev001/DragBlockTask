    ...
    <div className='min-h-[calc(100vh-65px)] max-h-[calc(100vh-70px)] overflow-x-auto mt-[5px] bg-white rounded-sm shadow-sm'>
      <div className="flex gap-[10px] p-[8px] items-start">
        {statusBlocks.map(block => (
          <div key={block.id} className="bg-gray-200 min-h-[150px] min-w-[260px] w-full p-[5px] rounded-sm border-[1px] border-gray-200">
            <div className="h-[35px] bg-green-500 text-[14px] text-white rounded-t-sm flex justify-center items-center">
              {block.title}
            </div>
